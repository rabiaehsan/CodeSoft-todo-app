              ...
              child: ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () {
                    ...
                    // Implement the logic to mark the task as completed and remove it
                    // You can use this context to interact with the Firebase collection
                    // Example: Remove task from Firestore using the task's unique ID
                    FirebaseFirestore.instance
                        .collection('tasks')
                        .doc(task.id)
                        .delete();
